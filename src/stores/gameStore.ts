...
export interface GameState {
    ...
    incrementPredatorsKilled: (amount: number) => void;
    ...
    subscribeWithSelector(
        persist(
            (set, get) => ({
                ...
                incrementResourcesCollected: (amount) => set((state) => ({
                    player: { ...state.player, totalResourcesCollected: state.player.totalResourcesCollected + amount }
                })),

                incrementPredatorsKilled: (amount) => set((state) => ({
                    player: { ...state.player, predatorsKilled: state.player.predatorsKilled + amount }
                })),
