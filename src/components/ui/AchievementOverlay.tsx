...
export function AchievementOverlay() {
    ...
    return (
        <div style={{
            ...
            <div>
                <div style={{ color: '#d4af37', fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '1px' }}>
                    Achievement Unlocked!
                </div>
                <div style={{ color: '#fff', fontSize: '18px', fontWeight: 'bold', margin: '2px 0' }}>
                    {recentUnlock.title}
                </div>
